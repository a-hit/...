...
loadTimeData.data = {
  ...
  "explanationParagraph": "korenanda.com では最近、Google セーフ ブラウジングにより、<a href=\"#\" id=\"diagnostic-link\">フィッシング行為が検出されました</a>。フィッシング サイトは、他のウェブサイトになりすましてユーザーを欺こうとするサイトです。",
  ...
  "primaryParagraph": "<strong>korenanda.com</strong> では、悪意のあるユーザーによって、ソフトウェアのインストールや個人情報（パスワード、電話番号、クレジット カードなど）の入力といった危険な操作を行うよう誘導される可能性があります。<a href=\"#\" id=\"learn-more-link\">詳細</a>",
